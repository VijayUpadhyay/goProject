...
func example2_marshalunmarshal() {
...
func main() {
	fmt.Println("Running 4 examples from struct")
	...
	fmt.Println("\n--- example3_struct_copy ---")
	example3_struct_copy()

	fmt.Println("\n--- example4_structtojson_2 ---")
	example4_structtojson_2()
